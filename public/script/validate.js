...
if (!numberPlateRegex.test(numberPlate.value.trim())) {
  ...
  // // // Validating for number plates.
  //   // // this is regex for number plate
  //   // let numberPlateRegex = /^U.*/
  //   // let numberPlateRegex1 = /^[A-Za-z0-9]{1,7}$/
  //   // let numberPlateRegex2 = /^[A-Z]{1,7}$/


  //   // if(numberPlate. value == ""){
  //   //   numberPlate.style.border = "1px solid red";
  //   //   numberPlateError.textContent = "Please enter a number plate.";
  //   //   numberPlateError.style =
  //   //     "color: red; font-size:11px; font-family:helvetica,Arial,sans-serif;";
  //   //   numberPlate.focus();
  //   //   error++;
  //   // }
  //   // else if(!numberPlate.value.match(numberPlateRegex)){
  //   //   numberPlate.style.border = "1px solid red";
  //   //   numberPlateError.textContent = "Number plate must be starting with U.";
  //   //   numberPlateError.style =
  //   //     "color: red; font-size:11px; font-family:helvetica,Arial,sans-serif;";
  //   //   numberPlate.focus();
  //   //   error++;
  ...
  //   // }
  //   // // else if(!numberPlate.value.match(numberPlateRegex2)){
  //   // //   numberPlate.style.border = "1px solid red";
  //   // //   numberPlateError.textContent = "should not be more than 7 characters.";
  //   // //   numberPlateError.style =
  //   // //     "color: red; font-size:11px; font-family:helvetica,Arial,sans-serif;";
  //   // //   numberPlate.focus();
  //   // //   error++;
